...
def benchmark_stock_processing(stock_manager: StockManager, stock_codes: List[str], iterations: int = 100) -> Dict[str, Any]:
    """
    测试股票数据处理性能
...
def benchmark_cache_performance(stock_manager: StockManager, stock_codes: List[str], iterations: int = 1000) -> Dict[str, Any]:
    """
    测试缓存性能
    ...
    result = {
        ...
        'performance_ratio': avg_cache_miss_time / avg_cache_hit_time if avg_cache_hit_time > 0 else float('inf')
    }
