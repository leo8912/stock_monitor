...
class AutomatedUpdaterTest:
    ...
    def test_updater_help(self):
        ...
        try:
            ...
            if result.returncode == 0 or "usage" in result.stdout.lower() or "Stock Monitor" in result.stdout:
    ...
    def test_updater_execution(self, update_package):
        ...
        try:
            ...
            args = [
                str(updater_exe),
                "--update-package", str(update_package.absolute()),
                "--target-dir", str(self.test_dir.absolute()),
                "--main-exe", "stock_monitor.exe",
                "--pid", "99999"  # 假的PID,不会等待
            ]
