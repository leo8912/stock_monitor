...
class MainWindow(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.market_stats_worker.stats_updated.connect(self.market_status_bar.update_status)
    ...
    def _setup_ui_components(self):
        ...
        # 启动后台刷新线程
        self.refresh_worker.start_refresh(self.current_user_stocks, self.refresh_interval)
